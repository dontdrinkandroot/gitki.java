...
public class AbstractPathStringModel extends AbstractChainedReadonlyModel<GitkiPath, String>
{
    public AbstractPathStringModel(IModel<? extends GitkiPath> parent) {
        super(parent);
    }
