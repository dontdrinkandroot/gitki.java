...
import net.dontdrinkandroot.wicket.bootstrap.component.list.createListGroup
...
class DirectoryEntriesPanel(id: String, model: IModel<List<GitkiPath>>) : PlainCard<List<GitkiPath>>(id, model) {
    ...
    override fun createAfterBody(id: String): Component = createListGroup(id, this.model) { id, model ->
